...
class ImpLexer(Lexer):
    tokens = {VAR, BEGIN, END, PID, NUM, IF, THEN, ELSE, ENDIF, WHILE, DO, ENDWHILE, REPEAT, UNTIL, FOR, FROM, TO, DOWNTO, ENDFOR, READ, WRITE, EQ, NEQ, GE, LE, GEQ, LEQ, ASSIGN, PLUS, MINUS, TIMES, DIV, MOD}
    literals = {',', ':', ';', '[', ']'}
    ignore = ' \t'
